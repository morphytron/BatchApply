...
build_exe_options = {"packages": ["os", "sys", "BatchApply", "ArgumentMatcher", "IOFile", "subprocess", "threading", "random", "re"], "optimize": 2, "excludes": ["tkinter, http"], "include_files": []}
...
setup(  name = "BatchApply",
        ...
        executables = [Executable(script="ba.py", copyright="2018", trademarks="Atomhid/Atomnia", base=base, shortcutName="BatchApply")]
        )
